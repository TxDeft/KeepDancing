//**********************************************************************************************************
// 
//文件名(File Name)：                              TotalEvalScoreIterator.cs
//
//功能描述(Description)：                          TotalEvalScoreIterator迭代器，用于遍历总体评价的分数标准
//
//作者(Author)：                                   李爽
//
...
public class TotalEvalScoreIterator : IIterator {
	//待遍历节点链表
	...
	public TotalEvalScoreIterator(XmlNodeList nodeList){
	    mNodeList = nodeList;
